...
{
	/// <summary>
	/// After saving the save file, we need to recompute the checksum or we will get errors - credits to Arefu
	/// Copied/modifed from here: https://github.com/Arefu/Wolf/blob/d904ca93a84e49dfc86a7c573778f245a194bcd5/Elroy/GameSaveData.cs
	/// </summary>
	public class ChecksumFixer
	{
		private static readonly byte[] ByteTable =
		{
		...
		public static void FixGameSaveSignatureOnDisk()
		{
		...
		{
			Buffer.BlockCopy(BitConverter.GetBytes(BitConverter.ToUInt32(SaveBytes, 16) + 1), 0, SaveBytes, 16, 4);
			Buffer.BlockCopy(BitConverter.GetBytes(GetSignature(SaveBytes)), 0, SaveBytes, 12, 4);
		}

		protected static uint GetSignature(byte[] ByteBuffer)
		{
